...
//		$this->workbook->setTempDir('/tmp');
		...
		$this->all_tables = array(DATABASE_LISTINGS, DATABASE_PERSONS, DATABASE_MEMBERS, DATABASE_TRADES, DATABASE_PENDING, DATABASE_LOGINS, DATABASE_LOGGING, DATABASE_CATEGORIES, DATABASE_STATES, DATABASE_FEEDBACK, DATABASE_REBUTTAL, DATABASE_NEWS, DATABASE_SESSION, DATABASE_UPLOADS, DATABASE_INCOME_TIES, DATABASE_CDM_PAGES, DATABASE_SETTINGS); 
