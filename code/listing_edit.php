...
$today = getdate();
$options = array('language'=>$lng_language, 'format'=>'dFY', 'minYear'=>$today['year'],'maxYear'=>$today['year']+5, 'addEmptyOption'=>'Y', 'emptyOptionValue'=>'0'); // changed 'language'=>'en' into 'language'=>$lng_language - changed by ejkv
