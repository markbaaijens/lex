...
// Define a key for executing remote backups; when this key is left empty, no remote backup can be made. 
// Under Linux a key can be easily generated by:
//   tr -dc "[:alpha:]" < /dev/urandom | head -c 32
// Remote backups can be executed (under Linux) as follows:
...
define("MEMBER_LIMIT_INIT_PERIOD", 182);       // Length of the initiation period in days
